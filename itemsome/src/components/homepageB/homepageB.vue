<template>
  <div class="homepageC" v-title data-title="免费商城B">
    <div class="navs_warp">
      <div class="navs">
      ...
      <div class="menu_l">
        <transition name="fadel">
          <ul v-if="showl">
            <li>
              <router-link to="/home/homepage/homepageA">百耀商城&nbsp;A</router-link>
            </li>
            <li>
              <router-link to="/home/homepage/homepageC">兑换商城&nbsp;C</router-link>
            </li>
          </ul>
        </transition>
      </div>
