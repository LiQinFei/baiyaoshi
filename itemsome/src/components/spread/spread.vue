  ...
  <div class="spread" v-title data-title="推广员">
    <div class="spread_head">
      ...
      <div class="sh_r">
        ...
        <div class="line"></div>
        <span>推广金额：{{datas.much}}元</span> <span>推广人数：{{datas.underling_number}}人</span>
    ...
    <div class="rank">
      ...
      <img @click="downP" class="pu" src="./pu.png" alt=""> <img @click="downT" class="tong" src="./tong.png" alt="">
      <img @click="downY" class="yin" src="./yin.png" alt=""> <img @click="downJ" class="jin" src="./jin.png" alt="">
    </div>
...
<script>
  ...
  export default {
    ...
    beforeRouteEnter(to, from, next) {
      ...
      let is_d = localStorage.getItem("is_distribut")
      if(oo == null){
        next({path : '/login'})
      }
      else if(is_d == 1){
        dialog.alert({
          ...
          if(ret.buttonIndex == 1){
            next({path : '/home/homepage/homepageA'})
          }
        })
      } else if(is_d == 2){
        next({path : '/apply'})
      } else if(is_d == 3){
        next({path : '/home/lding'})
      } else {
        next()
      }
    },
